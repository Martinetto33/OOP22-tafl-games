...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item Il \textbf{trono} è la cella in cui è posizionato inizialmente il re. Il trono ha la particolarità di poter essere implicato nella cattura, contando come una pedina alleata sia per l'attaccante che per il difensore. In pratica schiacciare una pedina fra il trono e un'altra pedina corrisponde a catturarla.
