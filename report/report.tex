...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item Il \textbf{trono} è la cella in cui è posizionato inizialmente il re, e solo il re può attraversare e/o fermarsi su questa cella. Il trono ha la particolarità di poter essere implicato nella cattura, contando come una pedina alleata sia per l'attaccante che per il difensore. In pratica schiacciare una pedina fra il trono e un'altra pedina corrisponde a catturarla.
		\item Le \textbf{uscite} sono celle presenti ad ognuno dei quattro angoli della griglia; se una di esse è raggiunta dal re, allora il difensore vince. Chiaramente, non è possibile posizionare sulle uscite nessuna pedina che non sia il re. Anche le uscite, come il trono, possono essere implicate nella cattura secondo le stesse modalità.
	\end{itemize}
	...
	\item Al termine della partita, i giocatori devono avere la possibilità di registrare il proprio risultato, immettendo anche il proprio nome; i risultati registrati dovranno poter essere visualizzati su una leaderboard.
\end{itemize}
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item solo a livello di pianificazione, su come strutturare il MatchPanel;
...
Permalinks:
\begin{itemize}
	\item \url{https://github.com/Martinetto33/OOP22-tafl-games/blob/d5ace9ae79460da3c35384b2e5eeb098f52c281e/src/main/java/taflgames/controller/settingsloader/SettingsLoaderImpl.java#L73-L89}
	\item \url{https://github.com/Martinetto33/OOP22-tafl-games/blob/d5ace9ae79460da3c35384b2e5eeb098f52c281e/src/main/java/taflgames/controller/settingsloader/SettingsLoaderImpl.java#L191-L204}
\end{itemize}

\subsubsection{Uso di \texttt{LoopingIterator} dalla libreria Apache Commons Collections}
Permalink: \url{https://github.com/Martinetto33/OOP22-tafl-games/blob/d5ace9ae79460da3c35384b2e5eeb098f52c281e/src/main/java/taflgames/model/Match.java#L26}

\subsubsection{Utilizzo della libreria SLF4J}
Utilizzata in più punti del codice. Un esempio: \url{https://github.com/Martinetto33/OOP22-tafl-games/blob/d5ace9ae79460da3c35384b2e5eeb098f52c281e/src/main/java/taflgames/controller/ControllerImpl.java#L38}

\subsubsection{Uso di \texttt{Stream} e lambda expressions}
Utilizzati in più punti del codice. Un esempio: \url{https://github.com/Martinetto33/OOP22-tafl-games/blob/09db6dcc6e6aed0e59f01fd4b5ac311bb6a8cb79/src/test/java/taflgames/TestBoardSetup.java#L322-L326}

\subsubsection{Uso di reflection}
Utilizzata in più punti in \texttt{TestBoardSetup.java}. Un esempio: \url{https://github.com/Martinetto33/OOP22-tafl-games/blob/5dc73630aea0869906d26fc6c0d7c2148217a038/src/test/java/taflgames/TestBoardSetup.java#L85-L88}

\subsubsection{Scrittura di metodo generico}
Permalink: \url{https://github.com/Martinetto33/OOP22-tafl-games/blob/09db6dcc6e6aed0e59f01fd4b5ac311bb6a8cb79/src/test/java/taflgames/TestBoardSetup.java#L313-L319}

\subsubsection{Uso di \texttt{Optional}}
Permalink: \url{https://github.com/Martinetto33/OOP22-tafl-games/blob/5dc73630aea0869906d26fc6c0d7c2148217a038/src/main/java/taflgames/model/Match.java#L77-L88}

\subsubsection{Uso di \texttt{javax.swing.JEditorPane} e \texttt{javax.swing.text.html.HTMLEditorKit} per il rendering di file HTML}
Permalink: \url{https://github.com/Martinetto33/OOP22-tafl-games/blob/09db6dcc6e6aed0e59f01fd4b5ac311bb6a8cb79/src/main/java/taflgames/view/scenes/RulesScene.java#L51-L70}
